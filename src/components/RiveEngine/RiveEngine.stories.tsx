...
const StudentPickerToolExample: StoryFn<RiveEngineProps & { gradeBand: GradeBand }> = (args) => {
  ...
  <div style={{textAlign: 'center', justifyItems: 'center', justifySelf: 'center'}}>
    ...
    <Button primary clickHandler={pickRandomStudentClicked} additionalClass={"connect__g68"}>Pick Random Student</Button>
  </div>
  );
};
...
const LinkInputValueToStateExample: StoryFn<RiveEngineProps> = (args) => {
  ...
  <div style={{textAlign: 'center', justifyItems: 'center', justifySelf: 'center'}}>
    ...
    <div>
      ...
      <Button primary clickHandler={() => setRatingValue(3)} additionalClass={"connect__g68"}>3 Stars</Button>
      <Button primary clickHandler={() => setRatingValue(4)} additionalClass={"connect__g68"}>4 Stars</Button>
      <Button primary clickHandler={() => setRatingValue(5)} additionalClass={"connect__g68"}>5 Stars</Button>
    </div>
  </div>
  );
};
