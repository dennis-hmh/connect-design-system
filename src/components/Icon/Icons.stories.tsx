...
const iconCategories = {
  ...
  Color: ['color'],
  Counters: ['counter-one'],
  SpecialShapes: ['special-shapes-one', 'special-shapes-two', 'special-shapes-three'],
  Pen: ['draw-outline', 'draw-size-one', 'draw-size-two', 'draw-size-three'],
  Lines: ['line-arrow', 'line-dashed', 'line'],
  Stamps: ['stamps-counter-outline', 'stamps-measure-outline', 'stamps-special-shapes-outline'],
